          ...
          <ul>
                      {appointmentsByDate.length > 0 ? (
                          appointmentsByDate.map((appointment) => (
                              <li key={`${appointment.type}-${appointment.id}`} className="bg-white p-4 rounded-md shadow-md mb-4">
                                  <div className="flex flex-col gap-2">
                                      <div className="flex justify-between items-center">
                                          ...
                                          {/* Only show "Ändra" button for real bookings */}
                                          {appointment.type === "booking" && (
                                              <button
                                      ...
                                      {/* Only show edit form if editing a real booking */}
                                      {editingBooking?.id === appointment.id && appointment.type === "booking" && (
